...
(ns org.domaindrivenarchitecture.config.commons.version-model-test
  (:require
    [clojure.test :refer :all]
    [schema.core :as s]
    [org.domaindrivenarchitecture.config.commons.version-model :as sut]))

(deftest version-conversions
  (testing "ver_fromstr: string to vector conversion"
    (is (= [0 0 0] (sut/ver_fromstr nil)))
    (is (= [1 2 0] (sut/ver_fromstr "1.2")))
    (is (= [1 2 3 4] (sut/ver_fromstr "1.2.3.4.5.5")))
    (is (= [1 2 3 4] (sut/ver_fromstr "1.2.3.4")))
